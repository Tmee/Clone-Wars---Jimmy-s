...
class JimmysApp < Sinatra::Base
  ...
  get '/item_description/:id' do |id|
    ...
    item_categories = DB.all_menu_categories
    # require 'pry'
    # binding.pry
    erb :item_description, locals: {menu_item: menu_item, item_categories: item_categories}
  end
  ...
  put '/admin/item/:id' do
    DB.update_menu_item(params)
    redirect '/admin/menu'
  end

  put '/admin/category/:id' do
    DB.update_menu_category(params)
    redirect '/admin/menu'
  end
